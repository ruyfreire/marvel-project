export const characterDetails = {
  ...
  etag: '3b89396aabea5b717f1b397e9465d76b48496fe7',
  data: {
    offset: 0,
    limit: 20,
    total: 1,
    ...
    results: [
      {
        ...
        comics: {
          available: 2734,
          collectionURI:
            'http://gateway.marvel.com/v1/public/characters/1009718/comics',
          items: [
            {
        ...
        series: {
          available: 754,
          collectionURI:
            'http://gateway.marvel.com/v1/public/characters/1009718/series',
          items: [
            {
            ...
            {
              resourceURI: 'http://gateway.marvel.com/v1/public/series/27975',
              name: 'Acts Of Evil (2020)',
            },
            {
            ...
            {
              resourceURI: 'http://gateway.marvel.com/v1/public/series/31965',
              name: 'Amazing Fantasy: Prelude Infinity Comic (2021)',
            },
            {
        ...
        stories: {
          available: 3748,
          collectionURI:
            'http://gateway.marvel.com/v1/public/characters/1009718/stories',
          items: [
            {
        ...
        events: {
          available: 44,
          collectionURI:
            'http://gateway.marvel.com/v1/public/characters/1009718/events',
          items: [
            {
        ...
        urls: [
          {
            type: 'detail',
            url: 'http://marvel.com/characters/66/wolverine?utm_campaign=apiRef&utm_source=15b6d3e76ec91a7a16995f3cd8af0ae5',
          },
          {
            type: 'wiki',
            url: 'http://marvel.com/universe/Wolverine_(James_Howlett)?utm_campaign=apiRef&utm_source=15b6d3e76ec91a7a16995f3cd8af0ae5',
          },
          {
            type: 'comiclink',
            url: 'http://marvel.com/comics/characters/1009718/wolverine?utm_campaign=apiRef&utm_source=15b6d3e76ec91a7a16995f3cd8af0ae5',
          },
        ],
      },
    ],
